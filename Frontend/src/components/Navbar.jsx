...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#fbfaff] z-100">
      <div className="flex justify-between">
        <div className="flex items-center justify-center gap-40">
          <img src={Logo} alt="Logo" className="w-40 h-20" />
          <div className="">
            <ul className="hidden  gap-10 font-bold text-[#190445CC] md:flex">
              <li className="hover:bg-gray-100 hover:w-max hover:h-max hover:rounded-md  hover:text-center text-[15px] ">
                Job Tracker
              </li>
              <li className="hover:bg-gray-100 hover:w-max hover:h-max hover:rounded-md hover:text-center text-[15px]">
                AI Resume Analyser
              ...
              <li className="">
                <button
                  className="inline-flex justify-center text-[15px] "
                  onClick={() => {
                    setIsOpen(!isOpen);
                  }}
                >
        ...
        <div className="flex items-center justify-center mr-15 ">
          <div className="hidden items-center justify-center gap-3 md:flex">
            <p className="font-bold mt-1 text-[#190445CC] hover:bg-gray-100 hover:w-max hover:h-max hover:rounded-md  hover:text-center text-[15px]">
              Login
            </p>
            <button className="bg-[#6A4FEB] font-bold text-[white] text-[12px] w-15 h-8 rounded-2xl">
              SignUp
            </button>
          </div>
