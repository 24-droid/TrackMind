...
const Resume = () => {
  ...
  return (
    <div
      ...
      } bg-gradient-to-br from-[#fbfaff] to-[#f4f0ff] py-20 px-6 md:px-20 flex flex-col md:flex-row items-center justify-center gap-16`}
    >
      ...
      <div className="max-w-xl text-center md:text-left">
        ...
        <p className="text-[#190445B3] text-[18px] md:text-[20px] mb-6">
          Tailoring your resume to each application land you more interviews.
          Use Trackmind's AI to help you better optimize your resume for the
